...
Because if you're looking at the file list in Github, it's hard to know if a file is the (good to view / generated one) vs the Scribble pre-processed slightly messy original file. It looks like it shows up twice...
  ...
  * [book_notes_first_90_days.md](https://github.com/rwilcox/my-learnings-docs/blob/master/book_notes_first_90_days.md)
  ...
  * [learning_azure.md](https://github.com/rwilcox/my-learnings-docs/blob/master/learning_azure.md)
  ...
  * [learning_emacs_lsp.md](https://github.com/rwilcox/my-learnings-docs/blob/master/learning_emacs_lsp.md)
  ...
  * [learning_terraform_provider_notes.md](https://github.com/rwilcox/my-learnings-docs/blob/master/learning_terraform_provider_notes.md)
  * [learning_terraform_terragrunt.md](https://github.com/rwilcox/my-learnings-docs/blob/master/learning_terraform_terragrunt.md)
